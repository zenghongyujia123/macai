...
function get_pre_pay_id(callback) {
  $.ajax({
    method: 'post',
    url: '/api_wechat_pay/payment/get_pre_pay_id',
    success: function (data) {
      if (data.prepay_id) {
        get_pre_pay_info(data.prepay_id, function (info) {
          onBridgeReady(info, function () {
...
function get_pre_pay_info(prepay_id, callback) {
  $.ajax({
    method: 'post',
...
function onBridgeReady(info, callback) {
  var payinfo = {
